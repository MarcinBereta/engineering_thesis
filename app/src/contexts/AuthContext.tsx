...
export const AuthProvider = ({
    ...
    const login = async (
        ...
        switch (provider) {
            ...
            //         let result: any = await googleLogin({
            //             email: userInfo.user.email,
            //         })
            //         if (result.status == 'OK') {
            //             await AsyncStorage.setItem('userInfo', result.data)
            //             setUserInfo(result.data)
            //         } else {
            //             if (result.err == 'NOT_FOUND') {
            //                 setError(t('not_found_lg'))
            //             } else if (result.err == 'INVALID_INPUT_TOO_LONG') {
            //                 setError(t('too_long_mail'))
            //             } else if (result.err == 'MAIL_INVALID') {
            //                 setError(t('mail_invalid'))
            //             } else if (result.err == 'INVALID_CREDENTIALS') {
            //                 setError(t('invalid_credentials'))
            //             } else {
            //                 setError(t('strange_error'))
            //             }
            //         }
            //     } catch (err) {
            //         console.error(err)
